...
$emailadd = $_POST['email'];
    ...
    header('location:http://webgista.ddns.net/mysql8/tourism_bkt/admin/login.php');

    $cek = mysqli_query($conn, $query);
  
  $token = date("Ymdhi").$username;
$homepage = file_get_contents("http://webgista.ddns.net/mysql8/mailtemplate.php?token=$token&user=$username");
  ...
  $mail->ErrorInfo;
    ...
    header('location:http://webgista.ddns.net/mysql8/hotel_bkt/admin/checkemailjo.php');
  }
