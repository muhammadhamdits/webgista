...
$homepage = file_get_contents("http://webgista.ddns.net/postgresql12/mailtemplate.php?token=$token&user=$username");
  ...
  $mail->ErrorInfo;
    ...
    header('location:http://webgista.ddns.net/postgresql12/hotel_bkt/admin/checkemailjo.php');
  }
